...
tabla8C_exp<- rbind(tabla82A100p,tabla82A150p,tabla82A200p,
                tabla82B100p,tabla82B150p,tabla82B200p)

names(tabla8C_exp)<- c("PATTERN","DEPENDENCY","P","CATEGORY", "MATRIX", "N")


patron_ab<- tabla8C_exp[tabla8C_exp$PATTERN=="AB" & tabla8C_exp$DEPENDENCY== 'Act',]
patron_cd<- tabla8C_exp[tabla8C_exp$PATTERN=="CD" & tabla8C_exp$DEPENDENCY== 'Act',]

patron_ef<- tabla8C_exp[tabla8C_exp$PATTERN=="EF" & tabla8C_exp$DEPENDENCY== 'Act',]
patron_gh<- tabla8C_exp[tabla8C_exp$PATTERN=="GH" & tabla8C_exp$DEPENDENCY== 'Act',]

tab8C_exp<- rbind(patron_ab,patron_cd,patron_ef,patron_gh)
tab8C_exp$MODEL<-gl(1,24, labels = "EXPL")
