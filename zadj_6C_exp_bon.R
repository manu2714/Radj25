...
seq6A150 <- genMarkov(n = 15000, transMat = m6A, 
                     chainLen = 150, wide = TRUE)
seq6B150 <- genMarkov(n = 15000, transMat = m6B, 
                     chainLen = 150, wide = TRUE)
seq6C150 <- genMarkov(n = 15000, transMat = m6C, 
                     chainLen = 150, wide = TRUE)
...
resid6A50<- llply(transiz6A50, function(x) chisq.test(x)$stdres)
...
resid6A50v$c26 <- sapply(X = resid6A50v$V32,zsignc)
...
resid6A50v$c56 <- sapply(X = resid6A50v$V35,zsignc)
...
resid6B50<- llply(transiz6B50, function(x) chisq.test(x)$stdres)
...
resid6B50v$c26 <- sapply(X = resid6B50v$V32,zsignc)
...
resid6B50v$c56 <- sapply(X = resid6B50v$V35,zsignc)
...
resid6C50<- llply(transiz6C50, function(x) chisq.test(x)$stdres)
...
resid6C50v$c26 <- sapply(X = resid6C50v$V32,zsignc)
...
resid6C50v$c56 <- sapply(X = resid6C50v$V35,zsignc)
...
resid6A100<- llply(transiz6A100, function(x) chisq.test(x)$stdres)
...
resid6A100v$c26 <- sapply(X = resid6A100v$V32,zsignc)
...
resid6A100v$c56 <- sapply(X = resid6A100v$V35,zsignc)
...
resid6B100<- llply(transiz6B100, function(x) chisq.test(x)$stdres)
...
resid6B100v$c26 <- sapply(X = resid6B100v$V32,zsignc)
...
resid6B100v$c56 <- sapply(X = resid6B100v$V35,zsignc)
...
resid6C100<- llply(transiz6C100, function(x) chisq.test(x)$stdres)
...
resid6C100v$c26 <- sapply(X = resid6C100v$V32,zsignc)
...
resid6C100v$c56 <- sapply(X = resid6C100v$V35,zsignc)
...
resid6A150<- llply(transiz6A150, function(x) chisq.test(x)$stdres)
...
resid6A150v$c26 <- sapply(X = resid6A150v$V32,zsignc)
...
resid6A150v$c56 <- sapply(X = resid6A150v$V35,zsignc)
...
resid6B150<- llply(transiz6B150, function(x) chisq.test(x)$stdres)
...
resid6B150v$c26 <- sapply(X = resid6B150v$V32,zsignc)
...
resid6B150v$c56 <- sapply(X = resid6B150v$V35,zsignc)
...
resid6C150<- llply(transiz6C150, function(x) chisq.test(x)$stdres)
...
resid6C150v$c26 <- sapply(X = resid6C150v$V32,zsignc)
...
resid6C150v$c56 <- sapply(X = resid6C150v$V35,zsignc)
...
tabla6_exp_bon<- rbind(tabla6A50p,tabla6A100p,tabla6A150p,
...
tab6bc2<- subset(tabla6_exp_bon,PATTERN == "BC" & DEPENDENCY == "Act" )
tab6dc2<- subset(tabla6_exp_bon,PATTERN == "DC" & DEPENDENCY == "Act" )
tab6_exp_bon<- rbind(tab6bc2,tab6dc2)
tab6_exp_bon$MODEL<- gl(1,18, labels = "BON-EXPL")
tab6_exp_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)
...
tab6ba1<- subset(tabla6_exp_bon,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab6bb1<- subset(tabla6_exp_bon,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab6bd1<- subset(tabla6_exp_bon,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab6be1<- subset(tabla6_exp_bon,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab6bf1<- subset(tabla6_exp_bon,PATTERN == "BF" & DEPENDENCY == "Inh" )


tab6da1<- subset(tabla6_exp_bon,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab6db1<- subset(tabla6_exp_bon,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab6dd1<- subset(tabla6_exp_bon,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab6de1<- subset(tabla6_exp_bon,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab6df1<- subset(tabla6_exp_bon,PATTERN == "DF" & DEPENDENCY == "Inh" )

tab6_inh_exp_bon<- rbind(tab6ba1,tab6bb1,tab6bd1,tab6be1,tab6bf1,
                         tab6da1,tab6db1,tab6dd1,tab6de1,tab6df1)
tab6_inh_exp_bon$MODEL<- gl(1,90, labels ="BON-EXPL")
tab6_inh_exp_bon$N<- rep(gl(3,1, labels = c("50","100","150")),30)

# Spurious pattern

tab6ac1<- subset(tabla6_exp_bon,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab6cc1<- subset(tabla6_exp_bon,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab6_sp_exp_bon<- rbind(tab6ac1,tab6cc1)
tab6_sp_exp_bon$MODEL<- gl(1,18, labels = "BON-EXPL")
tab6_sp_exp_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)
