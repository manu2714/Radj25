...
dim6<- ldply(resid6A150,dim)
falsos<-which(dim6$V1 != 6 | dim6$V2 !=6)
length(falsos)

#resid6A150 <- resid6A150[-falsos]
...
dim6<- ldply(resid6B150,dim)
falsos<-which(dim6$V1 != 6 | dim6$V2 !=6)
length(falsos)

#resid6B150 <- resid6B150[-falsos]
...
dim6<- ldply(resid6C150,dim)
falsos<-which(dim6$V1 != 6 | dim6$V2 !=6)
length(falsos)

#resid6C150 <- resid6C150[-falsos]
...
tabla6_exp<- rbind(tabla6A50p,tabla6A100p,tabla6A150p,
...
tab6bc1<- subset(tabla6_exp,PATTERN == "BC" & DEPENDENCY == "Act" )
tab6dc1<- subset(tabla6_exp,PATTERN == "DC" & DEPENDENCY == "Act" )
tab6_exp<- rbind(tab6bc1,tab6dc1)
tab6_exp$MODEL<- gl(1,18, labels = "EXPL")
tab6_exp$N<- rep(gl(3,1, labels = c("50","100","150")),6)
...
tab6ba1<- subset(tabla6_exp,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab6bb1<- subset(tabla6_exp,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab6bd1<- subset(tabla6_exp,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab6be1<- subset(tabla6_exp,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab6bf1<- subset(tabla6_exp,PATTERN == "BF" & DEPENDENCY == "Inh" )


tab6da1<- subset(tabla6_exp,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab6db1<- subset(tabla6_exp,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab6dd1<- subset(tabla6_exp,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab6de1<- subset(tabla6_exp,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab6df1<- subset(tabla6_exp,PATTERN == "DF" & DEPENDENCY == "Inh" )

tab6_inh_exp<- rbind(tab6ba1,tab6bb1,tab6bd1,tab6be1,tab6bf1,
                     tab6da1,tab6db1,tab6dd1,tab6de1,tab6df1)
tab6_inh_exp$MODEL<- gl(1,90, labels = "EXPL")
tab6_inh_exp$N<- rep(gl(3,1, labels = c("50","100","150")),30)

# Spurious pattern

tab6ac1<- subset(tabla6_exp,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab6cc1<- subset(tabla6_exp,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab6_sp_exp<- rbind(tab6ac1,tab6cc1)
tab6_sp_exp$MODEL<- gl(1,18, labels = "EXPL")
tab6_sp_exp$N<- rep(gl(3,1, labels = c("50","100","150")),6)
