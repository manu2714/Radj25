...
# Matrix A significant cells [A,B] and [C,D]
...
# Matrix B with p = 6/8, 4 cells significant:  [A,B], [C,D] [E,F] y [G,H]
...
tabla8C_lm<- rbind(tabla82A100p,tabla82A150p,tabla82A200p,
                    tabla82B100p,tabla82B150p,tabla82B200p)

names(tabla8C_lm)<- c("PATTERN","DEPENDENCY","P","CATEGORY", "MATRIX", "N")


patron_ab_lm<- tabla8C_lm[tabla8C_lm$PATTERN=="AB" & tabla8C_lm$DEPENDENCY== 'Act',]
patron_cd_lm<- tabla8C_lm[tabla8C_lm$PATTERN=="CD" & tabla8C_lm$DEPENDENCY== 'Act',]

patron_ef_lm<- tabla8C_lm[tabla8C_lm$PATTERN=="EF" & tabla8C_lm$DEPENDENCY== 'Act',]
patron_gh_lm<- tabla8C_lm[tabla8C_lm$PATTERN=="GH" & tabla8C_lm$DEPENDENCY== 'Act',]

tab8C_lm<- rbind(patron_ab_lm,patron_cd_lm,
                    patron_ef_lm,patron_gh_lm)
tab8C_lm$MODEL<-gl(1,24, labels = "LOGL")
