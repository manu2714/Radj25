...
tabla8C_chi<- rbind(tabla82A100p,tabla82A150p,tabla82A200p,
                    tabla82B100p,tabla82B150p,tabla82B200p)

names(tabla8C_chi)<- c("PATTERN","DEPENDENCY","P","CATEGORY", "MATRIX", "N")


patron_ab_chi<- tabla8C_chi[tabla8C_chi$PATTERN=="AB" & tabla8C_chi$DEPENDENCY== 'Act',]
patron_cd_chi<- tabla8C_chi[tabla8C_chi$PATTERN=="CD" & tabla8C_chi$DEPENDENCY== 'Act',]

patron_ef_chi<- tabla8C_chi[tabla8C_chi$PATTERN=="EF" & tabla8C_chi$DEPENDENCY== 'Act',]
patron_gh_chi<- tabla8C_chi[tabla8C_chi$PATTERN=="GH" & tabla8C_chi$DEPENDENCY== 'Act',]

tab8C_chi<- rbind(patron_ab_chi,patron_cd_chi,
                    patron_ef_chi,patron_gh_chi)
tab8C_chi$MODEL<-gl(1,24, labels = "GBL")
