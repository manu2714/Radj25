...
tabla6_lm<- rbind(tabla6A50p,tabla6A100p,tabla6A150p,
...
tab6bc5<- subset(tabla6_lm,PATTERN == "BC" & DEPENDENCY == "Act" )
tab6dc5<- subset(tabla6_lm,PATTERN == "DC" & DEPENDENCY == "Act" )
tab6_lm<- rbind(tab6bc5,tab6dc5)
tab6_lm$MODEL<- gl(1,18, labels = "LOGL")
tab6_lm$N<- rep(gl(3,1, labels = c("50","100","150")),6)



# Inhibition patterns

tab6ba1<- subset(tabla6_lm,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab6bb1<- subset(tabla6_lm,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab6bd1<- subset(tabla6_lm,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab6be1<- subset(tabla6_lm,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab6bf1<- subset(tabla6_lm,PATTERN == "BF" & DEPENDENCY == "Inh" )

tab6da1<- subset(tabla6_lm,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab6db1<- subset(tabla6_lm,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab6dd1<- subset(tabla6_lm,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab6de1<- subset(tabla6_lm,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab6df1<- subset(tabla6_lm,PATTERN == "DF" & DEPENDENCY == "Inh" )

tab6_inh_lm<- rbind(tab6ba1,tab6bb1,tab6bd1,tab6be1,tab6bf1,
                    tab6da1,tab6db1,tab6dd1,tab6de1,tab6df1)
tab6_inh_lm$MODEL<- gl(1,90, labels = "LOGL")
tab6_inh_lm$N<- rep(gl(3,1, labels = c("50","100","150")),30)

# Spurious pattern

tab6ac1<- subset(tabla6_lm,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab6cc1<- subset(tabla6_lm,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab6_sp_lm<- rbind(tab6ac1,tab6cc1)
tab6_sp_lm$MODEL<- gl(1,18, labels = "LOGL")
tab6_sp_lm$N<- rep(gl(3,1, labels = c("50","100","150")),6)
