...
# Matriz A casillas significativas (1,2) y (3,2)
...
# Matriz B con p = 6/8, 4 casillas significativas  (1,2), (3,2), (5,2) y (6,2)
...
# Matriz C con p = 6/8, 6 casillas significativas (1,2), (3,2), (5,2), (6,2), (7,2) y (8,2)
...
patron_ab<- tabla8B[tabla8B$Patrón=="AB" & tabla8B$Dependencia== 'Act',]
patron_cb<- tabla8B[tabla8B$Patrón=="CB" & tabla8B$Dependencia== 'Act',]

patron_eb<- tabla8B[tabla8B$Patrón=="EB" & tabla8B$Dependencia== 'Act',]
patron_fb<- tabla8B[tabla8B$Patrón=="FB" & tabla8B$Dependencia== 'Act',]

patron_gb<- tabla8B[tabla8B$Patrón=="GB" & tabla8B$Dependencia== 'Act',]
patron_hb<- tabla8B[tabla8B$Patrón=="HB" & tabla8B$Dependencia== 'Act',]
