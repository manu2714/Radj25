...
buenos<- which(chi282A150v > qchisq(.95,49))
length(buenos)
...
tabla_r2_lm<- rbind(patron_be,patron_dc,patron_ca,patron_fd,
                     patron_eh, patron_gb)
tabla_r2_lm$MODEL <- gl(1, 54, labels = "LOGL")
tabla_r2_lm$N <- rep(gl(3, 1, labels = c("100","150","200")),18)
