...
seq82B150 <- genMarkov(n = 16000, transMat = m82B, 
                     chainLen = 150, wide = TRUE)
...
dim8<- ldply(seq82A100,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82A100 <- transiz82A100[-falsos]

chisq82A100<- llply(transiz82A100,function(x) chisq.test(x)$statistic)
chi82A100<- llply(chisq82A100, as.vector)
chi282A100v<- unlist(chi82A100)
buenos<- which(chi82A100 > qchisq(.95,49))
length(buenos)

transiz82A100<- transiz82A100[buenos]
resid82A100<- llply(transiz82A100, function(x) chisq.test(x)$stdres)
...
datosLong82A100$CATEGORY<- rep(nombres8,5000)

tabla82A100<-table(datosLong82A100$CATEGORY,datosLong82A100$MEASURE)
...
dim8<- ldply(seq82A150,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82A150 <- transiz82A150[-falsos]

chisq82A150<- llply(transiz82A150,function(x) chisq.test(x)$statistic)
chi82A150<- llply(chisq82A150, as.vector)
chi282A150v<- unlist(chi82A150)
buenos<- which(chi82A150 > qchisq(.95,49))
length(buenos)

transiz82A150<- transiz82A150[buenos]
resid82A150<- llply(transiz82A150, function(x) chisq.test(x)$stdres)
...
datosLong82A150$CATEGORY<- rep(nombres8,5000)

tabla82A150<-table(datosLong82A150$CATEGORY,datosLong82A150$MEASURE)
...
dim8<- ldply(seq82A200,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82A200 <- transiz82A200[-falsos]

chisq82A200<- llply(transiz82A200,function(x) chisq.test(x)$statistic)
chi82A200<- llply(chisq82A200, as.vector)
chi282A200v<- unlist(chi82A200)
buenos<- which(chi82A200 > qchisq(.95,49))
length(buenos)

transiz82A200<- transiz82A200[buenos]
resid82A200<- llply(transiz82A200, function(x) chisq.test(x)$stdres)

#resid82A200 <- resid82A200[-falsos]
...
datosLong82A200$CATEGORY<- rep(nombres8,5000)

tabla82A200<-table(datosLong82A200$CATEGORY,datosLong82A200$MEASURE)
...
dim8<- ldply(seq82B100,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82A150 <- transiz82A150[-falsos]

chisq82B100<- llply(transiz82B100,function(x) chisq.test(x)$statistic)
chi82B100<- llply(chisq82B100, as.vector)
chi282B100v<- unlist(chi82B100)
buenos<- which(chi82B100 > qchisq(.95,49))
length(buenos)

transiz82B100<- transiz82B100[buenos]
resid82B100<- llply(transiz82B100, function(x) chisq.test(x)$stdres)
...
datosLong82B100$CATEGORY<- rep(nombres8,5000)

tabla82B100<-table(datosLong82B100$CATEGORY,datosLong82B100$MEASURE)
...
dim8<- ldply(seq82B150,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82A150 <- transiz82A150[-falsos]

chisq82B150<- llply(transiz82B150,function(x) chisq.test(x)$statistic)
chi82B150<- llply(chisq82B150, as.vector)
chi282B150v<- unlist(chi82B150)
...
datosLong82B150$CATEGORY<- rep(nombres8,5000)

tabla82B150<-table(datosLong82B150$CATEGORY,datosLong82B150$MEASURE)
...
dim8<- ldply(seq82B200,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82B200 <- transiz82B200[-falsos]

chisq82B200<- llply(transiz82B200,function(x) chisq.test(x)$statistic)
chi82B200<- llply(chisq82B200, as.vector)
chi282B200v<- unlist(chi82B200)
buenos<- which(chi82B200 > qchisq(.95,49))
length(buenos)

transiz82B200<- transiz82B200[buenos]
resid82B200<- llply(transiz82B200, function(x) chisq.test(x)$stdres)

#resid82B200 <- resid82B200[-falsos]
...
datosLong82B200$CATEGORY<- rep(nombres8,5000)

tabla82B200<-table(datosLong82B200$CATEGORY,datosLong82B200$MEASURE)
...
dim8<- ldply(seq82C100,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82C100 <- transiz82C100[-falsos]

chisq82C100<- llply(transiz82C100,function(x) chisq.test(x)$statistic)
chi82C100<- llply(chisq82C100, as.vector)
chi282C100v<- unlist(chi82C100)
buenos<- which(chi82C100 > qchisq(.95,49))
length(buenos)

transiz82C100<- transiz82C100[buenos]
resid82C100<- llply(transiz82C100, function(x) chisq.test(x)$stdres)
...
datosLong82C100$CATEGORY<- rep(nombres8,5000)

tabla82C100<-table(datosLong82C100$CATEGORY,datosLong82C100$MEASURE)
...
dim8<- ldply(seq82C150,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82C150 <- transiz82C150[-falsos]

chisq82C150<- llply(transiz82C150,function(x) chisq.test(x)$statistic)
chi82C150<- llply(chisq82C150, as.vector)
chi282C150v<- unlist(chi82C150)
buenos<- which(chi82C150 > qchisq(.95,49))
length(buenos)

transiz82C150<- transiz82C150[buenos]
resid82C150<- llply(transiz82C150, function(x) chisq.test(x)$stdres)
...
datosLong82C150$CATEGORY<- rep(nombres8,5000)

tabla82C150<-table(datosLong82C150$CATEGORY,datosLong82C150$MEASURE)
...
dim8<- ldply(seq82C200,dim)
falsos<-which(dim8$V1 != 8 | dim8$V2 != 8)
length(falsos)

#transiz82C200 <- transiz82C200[-falsos]

chisq82C200<- llply(transiz82C200,function(x) chisq.test(x)$statistic)
chi82C200<- llply(chisq82C200, as.vector)
chi282C200v<- unlist(chi82C200)
buenos<- which(chi82C200 > qchisq(.95,49))
length(buenos)

transiz82C200<- transiz82C200[buenos]
resid82C200<- llply(transiz82C200, function(x) chisq.test(x)$stdres)
...
datosLong82C200$CATEGORY<- rep(nombres8,5000)

tabla82C200<-table(datosLong82C200$CATEGORY,datosLong82C200$MEASURE)
...
tabla_r1_chi<- rbind(patron_ab,patron_cb,patron_eb,patron_fb,
                     patron_gb, patron_hb)
tabla_r1_chi$MODEL <- gl(1, 54, labels = "GBL")
tabla_r1_chi$N <- rep(gl(3, 1, labels = c("100","150","200")),18)
