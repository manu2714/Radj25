...
tabla8_lm_bon<- rbind(tabla8A50p,tabla8A100p,tabla8A150p,
...
tab8bc1<- subset(tabla8_lm_bon,PATTERN == "BC" & DEPENDENCY == "Act" )
tab8dc1<- subset(tabla8_lm_bon,PATTERN == "DC" & DEPENDENCY == "Act" )
tab8_lm_bon<- rbind(tab8bc1,tab8dc1)
tab8_lm_bon$MODEL<- gl(1,18, labels = "BON-LOGL")
tab8_lm_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)


# Inhibition patterns


tab8ba1<- subset(tabla8_lm_bon,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab8bb1<- subset(tabla8_lm_bon,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab8bd1<- subset(tabla8_lm_bon,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab8be1<- subset(tabla8_lm_bon,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab8bf1<- subset(tabla8_lm_bon,PATTERN == "BF" & DEPENDENCY == "Inh" )
tab8bg1<- subset(tabla8_lm_bon,PATTERN == "BG" & DEPENDENCY == "Inh" )
tab8bh1<- subset(tabla8_lm_bon,PATTERN == "BH" & DEPENDENCY == "Inh" )


tab8da1<- subset(tabla8_lm_bon,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab8db1<- subset(tabla8_lm_bon,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab8dd1<- subset(tabla8_lm_bon,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab8de1<- subset(tabla8_lm_bon,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab8df1<- subset(tabla8_lm_bon,PATTERN == "DF" & DEPENDENCY == "Inh" )
tab8dg1<- subset(tabla8_lm_bon,PATTERN == "DG" & DEPENDENCY == "Inh" )
tab8dh1<- subset(tabla8_lm_bon,PATTERN == "DH" & DEPENDENCY == "Inh" )

tab8_inh_lm_bon<- rbind(tab8ba1, tab8bb1,tab8bd1,tab8be1,tab8bf1,
                    tab8bg1, tab8bh1,tab8da1,tab8db1,tab8dd1,
                    tab8de1,tab8df1,tab8dg1,tab8dh1)

tab8_inh_lm_bon$MODEL<- gl(1,126, labels = "BON-LOGL")
tab8_inh_lm_bon$N<- rep(gl(3,1, labels = c("50","100","150")),42)

# Spureous pattern

tab8ac1<- subset(tabla8_lm_bon,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab8cc1<- subset(tabla8_lm_bon,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab8_sp_lm_bon<- rbind(tab8ac1,tab8cc1)

tab8_sp_lm_bon$MODEL<- gl(1,18, labels = "BON-LOGL")
tab8_sp_lm_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)
