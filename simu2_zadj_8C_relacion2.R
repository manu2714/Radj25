...
# Matriz A casillas significativas (1,2) y (2,1)
...
# Matriz B con p = 6/8, 4 casillas significativas  (1,2), (2,1), (3,4) y (4,3)
...
# Matriz C con p = 6/8, 6 casillas significativas (1,2), (2,1), (3,4), (4,3), (5,6) y (6,5)
...
tabla8<- rbind(tabla82A100p,tabla82A150p,tabla82A200p,tabla82B100p,tabla82B150p,
               tabla82B200p, tabla82C100p,tabla82C150p,tabla82C200p)

patron_ab<- tabla8[tabla8$Patrón=="AB" & tabla8$Dependencia== 'Act',]
patron_ba<- tabla8[tabla8$Patrón=="BA" & tabla8$Dependencia== 'Act',]

patron_cd<- tabla8[tabla8$Patrón=="CD" & tabla8$Dependencia== 'Act',]
patron_dc<- tabla8[tabla8$Patrón=="DC" & tabla8$Dependencia== 'Act',]

patron_ef<- tabla8[tabla8$Patrón=="EF" & tabla8$Dependencia== 'Act',]
patron_fe<- tabla8[tabla8$Patrón=="FE" & tabla8$Dependencia== 'Act',]
