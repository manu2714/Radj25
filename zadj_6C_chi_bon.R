...
tabla6_chi_bon<- rbind(tabla6A50p,tabla6A100p,tabla6A150p,
...
tab6bc1<- subset(tabla6_chi_bon,PATTERN == "BC" & DEPENDENCY == "Act" )
tab6dc1<- subset(tabla6_chi_bon,PATTERN == "DC" & DEPENDENCY == "Act" )
tab6_chi_bon<- rbind(tab6bc1,tab6dc1)
tab6_chi_bon$MODEL<- gl(1,18, labels = "BON-GBL")
tab6_chi_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)



# Inhibition patterns

tab6ba1<- subset(tabla6_chi_bon,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab6bb1<- subset(tabla6_chi_bon,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab6bd1<- subset(tabla6_chi_bon,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab6be1<- subset(tabla6_chi_bon,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab6bf1<- subset(tabla6_chi_bon,PATTERN == "BF" & DEPENDENCY == "Inh" )


tab6da1<- subset(tabla6_chi_bon,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab6db1<- subset(tabla6_chi_bon,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab6dd1<- subset(tabla6_chi_bon,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab6de1<- subset(tabla6_chi_bon,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab6df1<- subset(tabla6_chi_bon,PATTERN == "DF" & DEPENDENCY == "Inh" )

tab6_inh_chi_bon<- rbind(tab6ba1, tab6bb1,tab6bd1,tab6be1,tab6bf1,
                     tab6da1,tab6db1,tab6dd1,tab6de1,tab6df1)
tab6_inh_chi_bon$MODEL<- gl(1,90, labels = "BON-GBL")
tab6_inh_chi_bon$N<- rep(gl(3,1, labels = c("50","100","150")),30)

# Spurious pattern

tab6ac1<- subset(tabla6_chi_bon,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab6cc1<- subset(tabla6_chi_bon,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab6_sp_chi_bon<- rbind(tab6ac1,tab6cc1)
tab6_sp_chi_bon$MODEL<- gl(1,18, labels = "BON-GBL")
tab6_sp_chi_bon$N<- rep(gl(3,1, labels = c("50","100","150")),6)
