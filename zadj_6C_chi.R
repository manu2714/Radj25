...
chisq6A50<- llply(transiz6A50,function(x) chisq.test(x)$statistic)
...
tabla6A50p$CATEGORY<- rep(6,108)
tabla6A50p$MATRIX<- rep("A",108)
...
chisq6B50<- llply(transiz6B50,function(x) chisq.test(x)$statistic)
...
chisq6C50<- llply(transiz6C50,function(x) chisq.test(x)$statistic)
...
tabla6A100p$CATEGORY<- rep(6,108)
tabla6A100p$MATRIX<- rep("A",108)
...
chisq6A150<- llply(transiz6A150,function(x) chisq.test(x)$statistic)
...
chisq6B150<- llply(transiz6B150,function(x) chisq.test(x)$statistic)
...
chisq6C150<- llply(transiz6C150,function(x) chisq.test(x)$statistic)
...
tabla6_chi<- rbind(tabla6A50p,tabla6A100p,tabla6A150p,
...
tab6bc1<- subset(tabla6_chi,PATTERN == "BC" & DEPENDENCY == "Act" )
tab6dc1<- subset(tabla6_chi,PATTERN == "DC" & DEPENDENCY == "Act" )
tab6_chi<- rbind(tab6bc1,tab6dc1)
tab6_chi$MODEL<- gl(1,18, labels = "GBL")
tab6_chi$N<- rep(gl(3,1, labels = c("50","100","150")),6)



# Inhibition patterns

tab6ba1<- subset(tabla6_chi,PATTERN == "BA" & DEPENDENCY == "Inh" )
tab6bb1<- subset(tabla6_chi,PATTERN == "BB" & DEPENDENCY == "Inh" )
tab6bd1<- subset(tabla6_chi,PATTERN == "BD" & DEPENDENCY == "Inh" )
tab6be1<- subset(tabla6_chi,PATTERN == "BE" & DEPENDENCY == "Inh" )
tab6bf1<- subset(tabla6_chi,PATTERN == "BF" & DEPENDENCY == "Inh" )


tab6da1<- subset(tabla6_chi,PATTERN == "DA" & DEPENDENCY == "Inh" )
tab6db1<- subset(tabla6_chi,PATTERN == "DB" & DEPENDENCY == "Inh" )
tab6dd1<- subset(tabla6_chi,PATTERN == "DD" & DEPENDENCY == "Inh" )
tab6de1<- subset(tabla6_chi,PATTERN == "DE" & DEPENDENCY == "Inh" )
tab6df1<- subset(tabla6_chi,PATTERN == "DF" & DEPENDENCY == "Inh" )

tab6_inh_chi<- rbind(tab6ba1, tab6bb1,tab6bd1,tab6be1,tab6bf1,
                     tab6da1,tab6db1,tab6dd1,tab6de1,tab6df1)
tab6_inh_chi$MODEL<- gl(1,90, labels = "GBL")
tab6_inh_chi$N<- rep(gl(3,1, labels = c("50","100","150")),30)

# Spurious pattern

tab6ac1<- subset(tabla6_chi,PATTERN == "AC" & DEPENDENCY == "Inh" )
tab6cc1<- subset(tabla6_chi,PATTERN == "CC" & DEPENDENCY == "Inh" )

tab6_sp_chi<- rbind(tab6ac1,tab6cc1)
tab6_sp_chi$MODEL<- gl(1,18, labels = "GBL")
tab6_sp_chi$N<- rep(gl(3,1, labels = c("50","100","150")),6)
